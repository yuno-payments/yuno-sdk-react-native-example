...
export function CheckoutScreen(): React.JSX.Element {
  ...
  const {state, startSession, presentWallet, presentWalletLite, reset} = useVtexWalletCheckout();
        ...
        <Card title="Payment method">
          ...
          <YunoPaymentMethods
            ...
            onPaymentMethodSelected={event => {
              console.log('🟢 [VTEX] onPaymentMethodSelected:', JSON.stringify(event));
              setMethodSelected(event.isSelected);
            }}
            onPaymentMethodError={error => {
              console.log('🔴 [VTEX] onPaymentMethodError:', JSON.stringify(error));
              setMethodSelected(false);
            }}
          ...
          {Platform.OS === 'ios' && (
            <Button
              title="Start payment Apple Pay"
              variant="success"
              onPress={() => void presentWalletLite()}
              testID="pay-apple-pay-lite-button"
            />
          )}
        </Card>
      )}
